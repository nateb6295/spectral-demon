...
**L14 is strictly redundant.** L14+L15 ablation = L15-only ablation. L14+L16 = L16-only. The earliest relay layer contributes nothing that isn't already captured by any later layer. Vestigial confirmed.
