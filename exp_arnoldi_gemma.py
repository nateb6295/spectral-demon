#!/usr/bin/env python3
"""Arnoldi eigenvalue computation for Gemma-2-9b-it.

Gemma doesn't support system role — prepend to user message instead.
"""
...
def main():
    ...
    with open(outpath, "w") as f:
        json.dump({
            ...
            "note": "Gemma: system role prepended to user message (no system role support)",
            "results": all_results,
