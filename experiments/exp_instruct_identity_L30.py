#!/usr/bin/env python3
"""Instruct × identity probes × L30 only — fills the displacement gap."""
...
def main():
    print("Loading Mistral-7B-Instruct-v0.3 — IDENTITY PROBES L30 ONLY...", flush=True)
    ...
    with open("/workspace/results_groove_five_instruct_identity_L30.json", "w") as f:
