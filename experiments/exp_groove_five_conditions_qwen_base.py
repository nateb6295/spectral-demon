#!/usr/bin/env python3
"""Five-condition V₂ coherence for Qwen-2.5-7B BASE.

Tests whether the denial spike (v2=0.105, erank=4.66) seen in Qwen instruct
is architectural (present in base) or training-derived (absent in base).

Same methodology as crossarch experiment. Base model uses raw text concatenation.
...
def main():
    ...
    with open("/workspace/results_groove_five_qwen_base.json", "w") as f:
        json.dump(all_results, f, indent=2, default=str)
    print(f"\nResults saved to /workspace/results_groove_five_qwen_base.json")
