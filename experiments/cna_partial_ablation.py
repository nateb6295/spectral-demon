#!/usr/bin/env python3
"""Partial ablation: does sorting scale linearly with number of ablated layers?"""
...
# Compute cross-name CV for each ablation condition
...
with open("/workspace/cna_partial_ablation_results.json", "w") as f:
